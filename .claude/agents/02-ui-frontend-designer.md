...
> **D9 (2026-09-25): flujo eficiente.** Lee y aplica `docs/architecture/workflow.md` (verificación mínima por tarea, informes de 15 líneas como máximo, documentación solo al cerrar un bloque; para tareas pequeñas que tocan Backend y UI, puedes recibir ambas partes).
