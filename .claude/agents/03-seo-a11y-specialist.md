...
## Tareas Pendientes [ ]
- [ ] **Fase C** No bloqueantes de B10 pendientes: borde de las opciones (3:1 si se oculta el radio), `X-Robots-Tag: noindex` en `/api/**` (producción), reflow a 320 px y zoom al 200 %.
...
- [x] **B10** Revisión de `fase-b/ui-exercise` y `fase-b/db`: ambas APTAS, sin bloqueantes (`docs/reviews/fase-b-b10.md`); §8 de la guía admite un párrafo compartido.
